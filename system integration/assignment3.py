...
mobile_link = driver.find_element("xpath","/html/body/div/div/div[3]/div[1]/div[2]/div[2]/div/div")
# mobile_link = driver.find_element("By.CSS_SELECTOR","span[data-component-type='s-product-image'] a")
mobile_link.click()
...
proceed_to_checkout= driver.find_element("xpath","https://www.flipkart.com/checkout/init?otracker=search")
